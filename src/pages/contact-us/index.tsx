                        ...
                        <div className="w-full md:w-[50%] xl:w-[50%]">
                            <div className="">
                                ...
                                <div className="mx-auto space-y-4 mb-6">
                                    <div className="flex flex-row xl:pr-7">
                                    ...
                                    <Link href="telto:+82-10-2320-8582" target="_blank" className="flex flex-row xl:pr-7">
                                        <div className="flex-shrink-0 w-14  h-14 border-2 p-3 rounded-md">
                                            <svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <Link href="mailto:sonomedex@gmail.com" target="_blank" className="flex flex-row xl:pr-7">
                                        <div className="flex-shrink-0 w-14  h-14 border-2 p-3 rounded-md">
