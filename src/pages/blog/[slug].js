          ...
          <div className="max-w-[1024px] m-auto">
            <div className="blog-post w-full  pt-8 pb-8">
              ...
              <div className="entry-bottom by-5 flex flex-col gap-3 md:flex-row justify-between">
                <div className="tags">
                  <ul className="pt-0">
                    <li className="text-lg font-medium text-body-color inline-flex items-center justify-center mr-2 relative top-1">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-2 text-Brown">
                    ...
                    <li className="inline-block p-[3px]">
                      <div className=" text-sm md:text-sm rounded hover:bg-secondry/30 block border border-secondry text-body-color px-2 py-1 transition" role="button">
                        Perfume
                      </div>
                    </li>
                    <li className="inline-block p-[3px]">
                ...
                <div className="social-icons single-share">
                  <div className="flex items-center opacity-100 top-full">
                    <h3 className="text-lg font-medium text-body-color pr-3">
                      Share this:
                    </h3>
