    ...
    <main className="pt-20 w-full flex flex-col justify-center items-center ">
      ...
      <button className="mt-5">
        <a className="relative inline-block text-sm font-medium text-[#fff] group active:text-orange-500 focus:outline-none focus:ring">
          <span className="absolute inset-0 transition-transform translate-x-0.5 translate-y-0.5 bg-[#BF1800] group-hover:translate-y-0 group-hover:translate-x-0"></span>
        </a>
        <Link
          href="/"
