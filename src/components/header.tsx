    ...
    return (
        <>
            ...
            <header className='fixed top-0 left-0 right-0 bg-white z-40 shadow-md'>
                <nav className="">
                    <div onClick={() => { setMegamenu(false), setDropdown(false), setNavbar(false) }} className="hidden md:block bg-dark-gray relative z-50 py-2">
                    ...
                    <div className="mx-auto max-w-[1730px] px-4 md:px-6 lg:px-8 2xl:px-20 flex flex-wrap justify-between items-center">
                        <Link href="/" className="flex items-center relative z-50">
                            <Image src={Logo} alt="logo" className='md:w-full w-3/4' onClick={() => { setMegamenu(false), setDropdown(false), setNavbar(false) }} />
                        </Link>
                        <button onClick={() => { setNavbar(!navbar), setDropdown(false), setMegamenu(false) }} type="button" className="inline-flex items-center p-1.5 my-1 ml-1 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none  focus:ring-gray-200 relative z-50">
                            {!navbar ? (
